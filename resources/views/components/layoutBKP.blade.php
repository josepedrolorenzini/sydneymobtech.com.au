...
@props([
    ...
    'title' => 'Sydney Mob Tech',
    // The Tailwind class applied to the body and html tags for background color
    'bodyClass' => 'bg-black'
])
...
<div class="min-h-full">
    <nav class="bg-black">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center">
                    <div class="shrink-0">
                        <img class="size-14" src="https://sydneymobtech.com.au/wp/wp-content/uploads/2025/05/logo_web_sydney_tech.webp" alt="sydney mob tech">
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-nav-link href="mailto:sydneymobtech@gmail.com"          :active="request()->is('#')">Email me</x-nav-link>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                    ...
                                    <img class="size-8 rounded-full" src="https://www.skateboardhere.com/images/toy-machine-skateboards1.jpg" alt="">
                                </button>
                            </div>
        ...
        <div class="md:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                ...
                <a href="mailto:sydneymobtech@gmail.com" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Mail </a>
            </div>
            <div class="border-t border-gray-700 pt-4 pb-3">
                <div class="flex items-center px-5">
                    <div class="shrink-0">
                        <img class="size-10 rounded-full" src="https://www.skateboardhere.com/images/toy-machine-skateboards1.jpg" alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Claudio</div>
                        <div class="text-sm font-medium text-gray-400">sydneymobtech@gmail.com</div>
                    </div>
    ...
    <header class="bg-black shadow-sm {{ request()->is('services') ?  '' : 'my-22'  }}  ">
